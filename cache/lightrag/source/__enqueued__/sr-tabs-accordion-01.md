...
**Slug:** `sr-tabs-accordion-01`
**HubSpot module ID:** 210345441571
...
**Module path:** `sr-2026/custom-modules/SR Tabs Accordion 01.module`
...
- **columns** (group) — Columns
  ...
  - **right_column** (group — repeater(default=1, max=4)) — Accordions
...
- `items_to_show` (number) — Accordions to show — _Number of Accordions to show on load_
- `cta_style` (choice) — Load More Button Style [required]
- `load_more_button_text` (text) — Load More Button Text
- `sticky` (boolean) — Sticky Content
