...
**Slug:** `sr-offer-bar-01`
**HubSpot module ID:** 210345737878
...
**Module path:** `sr-2026/custom-modules/SR Offer Bar 01.module`
...
- **columns** (group) — Columns
  - **left_column** (group — repeater(default=1, max=4) ; when image EQUAL null) — Image
...
- `image` (image) — Image — _Recommended size: 320x600px_
...
- `cc6e9528-59a8-3fe0-d2d3-1b8cdd759d1b` (choice) — Column Vertical Align [required]
