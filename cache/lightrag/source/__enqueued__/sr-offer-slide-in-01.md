...
**Slug:** `sr-offer-slide-in-01`
**HubSpot module ID:** 210345441538
...
**Module path:** `sr-2026/custom-modules/SR Offer Slide In 01.module`
...
- `slide_in_on_scroll` (boolean) — Slide in on scroll
- `show_label` (text) — Show Label
- `hide_label` (text) — Hide Label
