...
**Slug:** `sr-testimonials-03`
**HubSpot module ID:** 210345399324
...
**Module path:** `sr-2026/custom-modules/SR Testimonials 03.module`
...
- `slides.image_corner_radius` (number) — Image Corner Radius — _Set the corner radius of the image_
- `slides.slide_author_name` (text) — Slide Author Name
- `slides.slide_author_title` (richtext) — Slide Author Title
- `slides.slide_content` (richtext) — Testimonial
