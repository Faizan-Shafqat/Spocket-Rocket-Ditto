...
**Slug:** `sr-offer-bar-07`
**HubSpot module ID:** 210345737890
...
**Module path:** `sr-2026/custom-modules/SR Offer Bar 07.module`
...
- **Feature** (group — repeater(default=4, max=4)) — Feature
  - **feature_heading** (group) — Heading
- **form** (group) — Form
...
- `feature.description` (richtext) — Description
- `feature.lead_text` (boolean) — Lead Text — _Turn on to make the Description text larger_
...
- `information` (richtext) — Information
