...
**Slug:** `sr-offer-exit-modal-01`
**HubSpot module ID:** 210345399209
...
**Module path:** `sr-2026/custom-modules/SR Offer Exit Modal 01.module`
...
- `design_settings.close_icon_color` (color) — Close Icon Color
- `design_settings.background_option` (choice) — Background Option [required]
- `design_settings.background_image` (backgroundimage) — Background Image [when design_settings.background_option MATCHES_REGEX image] — _Source for background image_
...
- `modal_image` (image) — Modal Image
- `modal_content` (richtext) — Modal Content
...
- `6b740b92-aeeb-a883-eb57-29cdcb99361f` (boolean) — Open Once
- `c05b9467-c0d1-b472-20b4-025b97517328` (boolean) — Timer
- `76d46f80-f9b6-a58b-ce80-7d206f090294` (number) — Timer [when c05b9467-c0d1-b472-20b4-025b97517328 EQUAL true]
