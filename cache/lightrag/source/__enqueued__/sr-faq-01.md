...
**Slug:** `sr-faq-01`
**HubSpot module ID:** 210345737827
**Inferred category:** FAQ
...
**Module path:** `sr-2026/custom-modules/SR FAQ 01.module`
...
- **design_settings** (group) — Design Settings
  - **design_settings.card_styles** (group) — FAQ Styles
...
- `design_settings.card_styles.dots_color` (color) — Slider Dots Color — _Color of the slider dots on mobile_
- `design_settings.card_styles.dots_color_active` (color) — Slider Dots Color Active — _Color of the active slider dot on mobile_
...
- `faq.faq_question` (text) — FAQ Question
- `faq.faq_answer` (richtext) — FAQ Answer
- `630c066f-e0c6-63fa-183c-205024d2927b` (number) — Number of Items to Show — _Use this to only show a certain number of items_
- `button.button_text` (text) — Button Text
- `button.button_style` (choice) — Button Style [required]
