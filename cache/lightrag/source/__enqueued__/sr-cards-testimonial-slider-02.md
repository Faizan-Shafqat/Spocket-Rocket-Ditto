...
**Slug:** `sr-cards-testimonial-slider-02`
**HubSpot module ID:** 210345399137
...
**Module path:** `sr-2026/custom-modules/SR Cards Testimonial Slider 02.module`
...
- `slides.quote` (richtext) — Quote
- `slides.author_image` (image) — Author Image
- `slides.author_name` (text) — Author Name
- `slides.author_title` (text) — Author Title
- `card_position` (choice) — Card Position [required]
- `negative_margin` (boolean) — Negative Margin
- `dots` (boolean) — Dots
- `dots_color` (color) — Dots Color [when dots EQUAL true]
- `dots_color_default` (color) — Dots Color (Default) [when dots EQUAL true]
