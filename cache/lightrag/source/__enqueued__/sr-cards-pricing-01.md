...
**Slug:** `sr-cards-pricing-01`
**HubSpot module ID:** 210345441364
...
**Module path:** `sr-2026/custom-modules/SR Cards Pricing 01.module`
...
- **1** (group — repeater(default=3, max=4)) — Column
  - **cta** (group) — CTA
...
- `design_settings.card_styles.text_align` (textalignment) — Text Align
...
- `column.price_prefix` (text) — Price Prefix
- `column.price` (text) — Price
- `column.price_suffix` (text) — Price Suffix
- `column.text` (richtext) — Text
- `column.featured_text` (text) — Featured Text
