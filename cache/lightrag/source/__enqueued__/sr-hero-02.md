...
**Slug:** `sr-hero-02`
**HubSpot module ID:** 210345737846
...
**Module path:** `sr-2026/custom-modules/SR Hero 02.module`
...
- **slides** (group) — Slides
  - **slides.slides** (group) — Slides
  - **slides.options** (group) — Slider Options
- **features** (group) — Features
  - **features.features** (group — repeater(default=3, max=∞)) — Features
...
- `feature_background_color` (color) — Feature Section Background Color [when design_settings.card_styles.position NOT_EQUAL in]
