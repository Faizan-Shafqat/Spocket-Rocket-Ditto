...
**Slug:** `sr-offer-parallax-02`
**HubSpot module ID:** 210345441536
...
**Module path:** `sr-2026/custom-modules/SR Offer Parallax 02.module`
...
- `parallax_image` (image) — Parallax Image — _Recommended size: 2880x1920px_
