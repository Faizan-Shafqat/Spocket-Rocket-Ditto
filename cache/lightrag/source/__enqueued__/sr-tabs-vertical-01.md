...
**Slug:** `sr-tabs-vertical-01`
**HubSpot module ID:** 210346724980
...
**Module path:** `sr-2026/custom-modules/SR Tabs Vertical 01.module`
...
- **1** (group — repeater(default=3, max=∞)) — Tab Item
  - **tab_heading** (group) — Heading
...
- `tab_item.tab_label` (text) — Tab Label
...
- `tab_item.tab_heading.class` (text) — CSS Class
- `tab_item.tab_content` (richtext) — Tab Content
