...
**Slug:** `sr-tabs-testimonials-01`
**HubSpot module ID:** 210345441587
...
**Module path:** `sr-2026/custom-modules/SR Tabs Testimonials 01.module`
...
- **1** (group — repeater(default=4, max=∞)) — Tab Item
...
- `tab_item.tab_photo` (image) — Tab Photo
- `tab_item.tab_label` (text) — Tab Label
- `tab_item.tab_content` (richtext) — Tab Content
- `tab_item.lead_text` (boolean) — Lead Text — _Turn on to make the Tab Content text larger_
