...
**Slug:** `sr-cards-filter-02`
**HubSpot module ID:** 210345399122
...
**Module path:** `sr-2026/custom-modules/SR Cards Filter 02.module`
...
- **2dc2a7d0-f841-1635-4ff4-1ebf82ba9aee** (group) — Filters
- **2** (group — repeater(default=7, max=∞)) — Column
...
- `column.col_tags` (text) — Tags
- `e9212944-d218-e794-4b2f-951062873179` (link) — Link
- `column.background_color_hover` (color) — Background Color Hover — _Background color when hovering over the card with link_
- `column.text_color_hover` (color) — Text Color Hover — _Text color when hovering over the card with link_
