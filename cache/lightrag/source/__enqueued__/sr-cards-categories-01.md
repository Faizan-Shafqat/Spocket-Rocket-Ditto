...
**Slug:** `sr-cards-categories-01`
**HubSpot module ID:** 210346101254
...
**Module path:** `sr-2026/custom-modules/SR Cards Categories 01.module`
...
- **1** (group — repeater(default=9, max=∞)) — Cards
  - **link_heading** (group) — Heading
...
- `link_heading.heading` (text) — Heading
- `link_heading.heading_size` (choice) — Size [required] — _HTML heading size_
- `link_heading.heading_display_size` (choice) — Display Size [required] — _Size that heading is displayed at_
- `link_heading.heading_color` (choice) — Color [required]
- `link_heading.heading_color_custom` (color) — Color [when link_heading.heading_color EQUAL custom]
- `link_heading.heading_align` (choice) — Align [required]
- `link_heading.class` (text) — CSS Class
- `items.description` (richtext) — Description
- `items.lead_text` (boolean) — Lead Text — _Turn on to make the Description text larger_
- `items.link` (link) — Card Link
- `5a01e500-dbfe-a221-58c2-7e60b5a650ab` (choice) — Number of Columns  [required]
- `align_columns` (choice) — Columns Alignment [required]
