...
**Slug:** `sr-cards-team-04`
**HubSpot module ID:** 210344001542
...
**Module path:** `sr-2026/custom-modules/SR Cards Team 04.module`
...
- **1** (group — repeater(default=8, max=∞)) — Team Members
...
- `design_settings.card_styles.border_radius` (number) — Main Card Border Radius
- `design_settings.card_styles.meta_border_radius` (number) — Meta Border Radius
...
- `column.image_link` (link) — Image Link
- `8ac21d73-a352-b701-3c3e-06f47043af82` (text) — Team Name
- `4cb9bbbe-69d9-b08e-987f-89e47038100b` (richtext) — Role
