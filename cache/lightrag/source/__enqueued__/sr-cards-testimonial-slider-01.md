...
**Slug:** `sr-cards-testimonial-slider-01`
**HubSpot module ID:** 210345737777
...
**Module path:** `sr-2026/custom-modules/SR Cards Testimonial Slider 01.module`
...
- **design_settings** (group) — Design Settings
  ...
  - **design_settings.author_meta_styles** (group) — Author Meta Styles
...
- `author_meta_styles.background_color` (choice) — Background Color [required]
- `author_meta_styles.background_gradient` (gradient) — Gradient [when author_meta_styles.background_color EQUAL gradient]
- `author_meta_styles.background_custom` (color) — Background Color [when author_meta_styles.background_color EQUAL custom]
- `author_meta_styles.text_color` (choice) — Text Color [required]
- `author_meta_styles.text_color_custom` (color) — Text Color [when author_meta_styles.text_color EQUAL custom]
- `author_meta_styles.spacing` (spacing) — Spacing
- `design_settings.author_meta_styles.border` (border) — Border
- `design_settings.author_meta_styles.border_radius` (number) — Border Radius
...
- `slides.slide_author_image` (image) — Slide Author Image — _Recommended Minimum Size: 120x120px_
