...
**Slug:** `sr-stats-04`
**HubSpot module ID:** 210345441557
...
**Module path:** `sr-2026/custom-modules/SR Stats 04.module`
...
- `stat_styles.background_color` (choice) — Background Color [required]
- `stat_styles.background_custom` (color) — Background Color [when stat_styles.background_color EQUAL custom]
- `stat_styles.text_color` (choice) — Text Color [required]
- `stat_styles.text_color_custom` (color) — Text Color [when stat_styles.text_color EQUAL custom]
