...
**Slug:** `sr-two-col-gallery-01`
**HubSpot module ID:** 210345441607
...
**Module path:** `sr-2026/custom-modules/SR Two Col Gallery 01.module`
...
- **1** (group — repeater(default=4, max=∞)) — Images
- **columns** (group) — Columns
  - **left_column** (group — repeater(default=1, max=4)) — Content
  - **right_column** (group — repeater(default=1, max=4)) — Gallery
...
- `64c20614-a151-f62b-7de5-44ce12aa1df9` (boolean) — Enable Lightbox
- `images.image` (image) — Image
- `images.overlay` (color) — Overlay
- `4e9802cb-649c-56bf-8a72-5e78f64f3050` (choice) — Image Position [required]
...
- `image_count` (choice) — Image Column Count
- `column_gap` (number) — Image Column Gap
