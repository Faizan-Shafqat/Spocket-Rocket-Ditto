...
**Slug:** `sr-hero-03`
**HubSpot module ID:** 210345737850
**Inferred category:** Hero
...
**Module path:** `sr-2026/custom-modules/SR Hero 03.module`
...
- **design_settings** (group) — Design Settings
  - **design_settings.card_styles** (group) — Features Styles
...
- **cta** (group — repeater(default=2, max=∞)) — CTA
...
- **slides** (group) — Slides
  - **slides.slides** (group — repeater(default=3, max=∞)) — Slides
  - **slides.options** (group) — Slider Options
- **features** (group) — Features
  - **features.features** (group) — Features
  - **features.columns** (group — repeater(default=1, max=4)) — Feature Columns
- **columns** (group) — Columns
  - **left_column** (group — repeater(default=1, max=4)) — Content
  - **right_column** (group — repeater(default=1, max=4)) — Slides
...
- `design_settings.card_styles.position` (choice) — Position [required]
...
- `design_settings.top_bottom_padding` (choice) — Top Bottom Padding [when height EQUAL auto] [required] — _Use default values: Uses any inherit padding valuesNo Padding: Set padding to 0Small: Uses a preset small paddingLarge: Uses a preset lar…_
...
- `design_settings.responsive_settings.tablet.tablet_top_bottom_padding` (choice) — Top Bottom Padding [when height EQUAL auto] [required]
...
- `design_settings.responsive_settings.mobile.mobile_top_bottom_padding` (choice) — Top Bottom Padding [when height EQUAL auto] [required]
...
- `slides.slide_image` (image) — Image — _Recommended size: 900x600px_
- `slides.slides.image_corner_radius` (number) — Image Corner Radius
- `autoplay` (boolean) — Autoplay
- `slides.options.autoplay_speed` (number) — Autoplay Speed [when autoplay EQUAL true]
- `dot_navigation` (boolean) — Dots
- `slides.options.dot_color` (color) — Dot Color [when dot_navigation EQUAL true]
- `slides.options.dot_color_default` (color) — Dot Color (Default) [when dot_navigation EQUAL true]
- `features.image` (image) — Image — _Recommended size: 128x128px_
- `features.content` (richtext) — Content
- `features.columns.columns` (choice) — Columns
- `features.columns.column_width` (choice) — Column Width [required]
- `features.columns.column_offset` (choice) — Column Offset [required]
- `features.columns.column_order` (number) — Column Order
...
- `height` (choice) — Height [required] — _Set to Auto to use the module's top and bottom padding values in the style tab_
