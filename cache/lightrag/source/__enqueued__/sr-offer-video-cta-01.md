...
**Slug:** `sr-offer-video-cta-01`
**HubSpot module ID:** 210345441546
...
**Module path:** `sr-2026/custom-modules/SR Offer Video CTA 01.module`
...
- `enable_animation` (boolean) — Enable Animation — _Enable to animate the video when it comes into view_
