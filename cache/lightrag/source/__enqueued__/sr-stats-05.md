...
**Slug:** `sr-stats-05`
**HubSpot module ID:** 210345399304
...
**Module path:** `sr-2026/custom-modules/SR Stats 05.module`
...
- **stats** (group — repeater(default=2, max=∞)) — Stats
  - **stat** (group) — Stat
- **columns** (group) — Columns
  - **left_column** (group — repeater(default=1, max=4)) — Content
  - **right_column** (group — repeater(default=1, max=4)) — Stats
...
- `stat.heading_color` (choice) — Color
...
- `columns.column_vertical_align` (choice) — Column Vertical Align [required]
