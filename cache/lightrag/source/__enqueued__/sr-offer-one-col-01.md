...
**Slug:** `sr-offer-one-col-01`
**HubSpot module ID:** 210345399213
...
**Module path:** `sr-2026/custom-modules/SR Offer One Col 01.module`
...
- `form.styles.max_width` (number) — Max Width — _Set the max width of the form. Set to 0 to disable._
...
- `form.follow_up_type_simple` (boolean) — Send a follow-up email [when null EQUAL null] — _To send a follow-up email, make sure the 'Set contacts created as marketing contacts’ setting is turned on. You can manage this in option…_
- `form.simple_email_for_live_id` (followupemail) — Email [when form.follow_up_type_simple EQUAL true OR null EQUAL null]
