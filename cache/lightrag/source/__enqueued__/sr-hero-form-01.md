...
**Slug:** `sr-hero-form-01`
**HubSpot module ID:** 210345441438
**Inferred category:** Hero (form variant)
...
**Module path:** `sr-2026/custom-modules/SR Hero Form 01.module`
...
- **columns** (group) — Columns
  ...
  - **right_column** (group — repeater(default=1, max=4)) — Form
...
- `form.styles.shadow` (boolean) — Shadow
...
- `left_column.column_breakpoint` (choice) — Column Breakpoint
...
- `right_column.column_breakpoint` (choice) — Column Breakpoint
...
- `vertical_align` (choice) — Vertical Align [required]
