...
**Slug:** `sr-offer-bar-05`
**HubSpot module ID:** 210345441458
...
**Module path:** `sr-2026/custom-modules/SR Offer Bar 05.module`
...
- **design_settings** (group) — Design Settings
  - **design_settings.accent_styles** (group) — Accent Styles
...
- **columns** (group) — Columns
  ...
  - **right_column** (group — repeater(default=1, max=4)) — Image
...
- `accent_styles.background_color` (choice) — Background Color [required]
- `3ff9e43e-6046-f38b-259f-506521d4e691` (gradient) — Gradient [when accent_styles.background_color EQUAL gradient]
- `accent_styles.background_custom` (color) — Background Color [when accent_styles.background_color EQUAL custom]
...
- `design_settings.background_custom` (color) — Background Color [when design_settings.background_option MATCHES_REGEX custom|image|video|gradient] — _For transparent images or before the image/video loads_
