...
**Slug:** `sr-element-testimonial`
**HubSpot module ID:** 210349901952
**Inferred category:** Testimonials
...
**Module path:** `sr-2026/custom-modules/SR Element Testimonial.module`
...
- **9cbf198f-4dcb-0f73-8f20-232e9fe07386** (group) — Icon
...
- `design_settings.background_image` (backgroundimage) — Background Image [when design_settings.background_option MATCHES_REGEX image|video] — _Source for background image_
- `design_settings.background_overlay_color` (color) — Background Overlay Color [when design_settings.background_option MATCHES_REGEX image|video] — _Overlay color on top of the image_
- `design_settings.background_color` (choice) — Background Color [when design_settings.background_option EQUAL color] [required]
- `design_settings.background_custom` (color) — Background Color [when design_settings.background_option MATCHES_REGEX custom|image|video] — _For transparent images or before the image loads_
...
- `cc5c2f87-ccf1-3ec9-bd3a-c621fa4d1357` (icon) — Icon
- `icon.icon_size` (number) — Icon Size
- `e4c503d9-e85a-7b6e-3f1b-9df74b945ac3` (color) — Icon Color
- `5e4685ff-8ebe-3c37-139a-32e99a115561` (choice) — Icon Background [required]
- `f29431b7-a7e5-4508-03f5-754d9d29cfa2` (color) — Icon Background Color [when 5e4685ff-8ebe-3c37-139a-32e99a115561 EQUAL custom]
- `9cbf198f-4dcb-0f73-8f20-232e9fe07386.purpose` (choice) — Purpose [required] — _The purpose of the icon, used for accessibility. If set to decorative, an additional attribute of aria-hidden="true" will be added to the…_
...
- `b2da4450-a826-050b-b77b-892b7c21e35d` (text) — Name
- `02c9092a-0d88-a5a6-db1c-85a1794306e3` (text) — Title
