...
**Slug:** `sr-video-slider-01`
**HubSpot module ID:** 210345399341
...
**Module path:** `sr-2026/custom-modules/SR Video Slider 01.module`
...
- **slides** (group — repeater(default=5, max=∞)) — Slides
  - **cta** (group) — CTA
...
- `slide_styles.arrow_left` (icon) — Arrow Left Icon
- `slide_styles.arrow_right` (icon) — Arrow Right Icon
...
- `design_settings.slide_border_radius` (number) — Active Slide Border Radius
