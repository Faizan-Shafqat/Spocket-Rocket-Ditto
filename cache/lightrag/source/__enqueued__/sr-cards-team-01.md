...
**Slug:** `sr-cards-team-01`
**HubSpot module ID:** 210345737770
...
**Module path:** `sr-2026/custom-modules/SR Cards Team 01.module`
...
- `card.title_display_size` (choice) — Display Size [required] — _Size that heading is displayed at_
...
- `column_vertical_align` (choice) — Cards Vertical Align
