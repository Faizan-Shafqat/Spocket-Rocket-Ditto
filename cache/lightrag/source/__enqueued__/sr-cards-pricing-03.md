...
**Slug:** `sr-cards-pricing-03`
**HubSpot module ID:** 210348825648
...
**Module path:** `sr-2026/custom-modules/SR Cards Pricing 03.module`
...
- **design_settings** (group) — Design Settings
  ...
  - **design_settings.cardinner_styles** (group) — Pricing Box Styles
...
- **pricing_card** (group) — Pricing Card
  - **pricing_heading** (group) — Heading
  - **cta** (group) — CTA
...
- **features_heading** (group) — Heading
- **features** (group — repeater(default=6, max=∞)) — Features
...
- `cardinner_styles.background_color` (choice) — Background Color [required]
- `cardinner_styles.background_gradient` (gradient) — Gradient [when cardinner_styles.background_color EQUAL gradient]
- `cardinner_styles.background_custom` (color) — Background Color [when cardinner_styles.background_color EQUAL custom]
- `cardinner_styles.text_color` (choice) — Text Color [required]
- `cardinner_styles.text_color_custom` (color) — Text Color [when cardinner_styles.text_color EQUAL custom]
- `cardinner_styles.spacing` (spacing) — Spacing
- `design_settings.cardinner_styles.border` (border) — Border
- `design_settings.cardinner_styles.border_radius` (number) — Border Radius
- `design_settings.cardinner_styles.shadow` (boolean) — Shadow
- `design_settings.cardinner_styles.horizontal` (number) — Horizontal [when design_settings.cardinner_styles.shadow EQUAL true] — _A positive value puts the shadow on the right side of the box, a negative value puts the shadow on the left side of the box_
- `design_settings.cardinner_styles.vertical` (number) — Vertical [when design_settings.cardinner_styles.shadow EQUAL true] — _The vertical offset of the shadow. A positive value puts the shadow below the box, a negative value puts the shadow above the box_
- `design_settings.cardinner_styles.blur` (number) — Blur [when design_settings.cardinner_styles.shadow EQUAL true] — _The blur radius. The higher the number, the more blurred the shadow will be_
- `design_settings.cardinner_styles.spread` (number) — Spread [when design_settings.cardinner_styles.shadow EQUAL true] — _The spread radius. A positive value increases the size of the shadow, a negative value decreases the size of the shadow_
- `design_settings.cardinner_styles.inset` (boolean) — Inset [when design_settings.cardinner_styles.shadow EQUAL true] — _Changes the shadow to an inner shadow_
- `design_settings.cardinner_styles.color` (color) — Color [when design_settings.cardinner_styles.shadow EQUAL true] — _The color of the shadow_
...
- `pricing_heading.heading` (text) — Heading
- `pricing_heading.heading_size` (choice) — Size [required] — _HTML heading size_
- `pricing_heading.heading_display_size` (choice) — Display Size [required] — _Size that heading is displayed at_
- `pricing_heading.heading_color` (choice) — Color [required]
- `pricing_heading.heading_color_custom` (color) — Color [when pricing_heading.heading_color EQUAL custom]
- `pricing_heading.heading_align` (choice) — Align [required]
- `pricing_card.pricing_heading.class` (text) — CSS Class
- `pricing_card.pricing_value` (text) — Pricing Value
- `pricing_card.pricing_description` (richtext) — Pricing Description
- `pricing_card.pricing_description_lead_text` (boolean) — Pricing Description Lead Text — _Turn on to make the Pricing Description text larger_
- `cta.cta_type` (choice) — CTA Type [required]
- `ctas.cta_style` (choice) — CTA Style [when cta.cta_type NOT_EQUAL none] [required]
- `pricing_card.ctas.default.background` (color) — Background
- `pricing_card.ctas.default.text` (color) — Text
- `pricing_card.ctas.default.border` (color) — Border
- `pricing_card.ctas.hover.background` (color) — Background
- `pricing_card.ctas.hover.text` (color) — Text
- `pricing_card.ctas.hover.border` (color) — Border Color
...
- `features_heading.heading` (text) — Heading
- `features_heading.heading_size` (choice) — Size [required] — _HTML heading size_
- `features_heading.heading_display_size` (choice) — Display Size [required] — _Size that heading is displayed at_
- `features_heading.heading_color` (choice) — Color [required]
- `features_heading.heading_color_custom` (color) — Color [when features_heading.heading_color EQUAL custom]
- `features_heading.heading_align` (choice) — Align [required]
- `features_heading.class` (text) — CSS Class
- `features.feature_text` (text) — Features Text
...
- `features.icon.icon_size` (number) — Icon Size [when features.icon.icon_type EQUAL icon]
...
- `features_description` (richtext) — Features Description
- `features_description_lead_text` (boolean) — Features Description Lead Text — _Turn on to make the Features Description text larger_
