...
**Slug:** `sr-cards-testimonial-grid-02`
**HubSpot module ID:** 210349901908
...
**Module path:** `sr-2026/custom-modules/SR Cards Testimonial Grid 02.module`
...
- **1** (group — repeater(default=3, max=∞)) — Card
- **cta** (group) — CTA
...
- `design_settings.card_styles.border_radius` (number) — Card Border Radius
...
- `card.team_image` (image) — Card Image
- `50739904-0312-4de0-bfbc-dd70f65ab7ed` (richtext) — Card Content
- `card.team_name` (text) — Card Name
- `card.team_title` (text) — Card Title
