...
**Slug:** `sr-cards-timeline-01`
**HubSpot module ID:** 210344001547
...
**Module path:** `sr-2026/custom-modules/SR Cards Timeline 01.module`
...
- **design_settings** (group) — Design Settings
  - **c99bcad3-429d-4cf5-3450-541360be6972** (group) — Timeline Styles
...
- **timeline_card** (group — repeater(default=4, max=∞)) — Cards
  - **timeline_heading** (group) — Heading
  - **cta** (group) — CTA
...
- `16d3567a-8593-f5db-8b4a-8e4e8c27eee7` (color) — Text Color
- `0698610f-7f3e-2492-220f-8fb0e012d352` (color) — Background Color
- `6b05173a-c148-6c46-5edc-9220526a8e6d` (color) — Arrows Color
- `01bfa0f7-2ab2-4014-a400-c03a0286fe75` (number) — Background Blur
...
- `timeline_card.timeline_image` (image) — Image
- `timeline_card.image_background_fit` (choice) — Image Background Fit [required]
- `timeline_heading.heading` (text) — Heading
- `timeline_heading.heading_size` (choice) — Size [required] — _HTML heading size_
- `timeline_heading.heading_display_size` (choice) — Display Size [required] — _Size that heading is displayed at_
- `timeline_heading.heading_color` (choice) — Color
- `timeline_heading.heading_color_custom` (color) — Color [when timeline_heading.heading_color EQUAL custom]
- `timeline_heading.heading_align` (choice) — Align [required]
- `timeline_card.timeline_heading.class` (text) — CSS Class
- `timeline_card.timeline_description` (richtext) — Description
- `timeline_card.timeline_year` (text) — Year
- `cta.cta_type` (choice) — CTA Type [required]
- `ctas.cta_style` (choice) — CTA Style [when cta.cta_type NOT_EQUAL none] [required]
- `timeline_card.ctas.default.background` (color) — Background
- `timeline_card.ctas.default.text` (color) — Text
- `timeline_card.ctas.default.border` (color) — Border
- `timeline_card.ctas.hover.background` (color) — Background
- `timeline_card.ctas.hover.text` (color) — Text
- `timeline_card.ctas.hover.border` (color) — Border Color
