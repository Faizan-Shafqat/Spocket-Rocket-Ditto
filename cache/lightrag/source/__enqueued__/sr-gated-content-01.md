...
**Slug:** `sr-gated-content-01`
**HubSpot module ID:** 210345399186
...
**Module path:** `sr-2026/custom-modules/SR Gated Content 01.module`
...
- `design_settings.backdrop_color` (color) — Backdrop Color
...
- `modal_open_at` (number) — Modal Open At % — _Set the percentage of the page where you would like the gated modal to pop up at._
- `modal_image` (image) — Modal Image — _Recommended size: 228x288px_
