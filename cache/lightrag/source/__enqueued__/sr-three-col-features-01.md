...
**Slug:** `sr-three-col-features-01`
**HubSpot module ID:** 210345738054
...
**Module path:** `sr-2026/custom-modules/SR Three Col Features 01.module`
...
- **1** (group — repeater(default=4, max=4)) — Items
- **cta** (group) — CTA
...
- `feature_image` (image) — Feature Image — _This is the center image_
- `items.icon` (image) — Icon — _Recommended size: 160x160px_
- `items.icon_2` (image) — Icon Hover — _Recommended size: 160x160px_
- `items.hover_image` (image) — Image on Hover — _Image to show in the phone on hover - Recommended size: 1125x2436px_
