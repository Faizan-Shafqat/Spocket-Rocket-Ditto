...
**Slug:** `sr-offer-bar-04`
**HubSpot module ID:** 210345441456
...
**Module path:** `sr-2026/custom-modules/SR Offer Bar 04.module`
...
- `design_settings.background_overlay_color` (color) — Background Overlay Color [when design_settings.background_option MATCHES_REGEX image|video]
