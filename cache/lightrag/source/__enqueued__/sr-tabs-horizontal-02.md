...
**Slug:** `sr-tabs-horizontal-02`
**HubSpot module ID:** 210345738023
...
**Module path:** `sr-2026/custom-modules/SR Tabs Horizontal 02.module`
...
- **1** (group — repeater(default=3, max=∞)) — Tabs
  - **tab_heading** (group) — Tab Label
  - **heading** (group) — Heading
- **columns** (group) — Columns
  - **left_column** (group — repeater(default=1, max=4)) — Tabs
...
- `tabs.tab_heading.background_color` (color) — Background Color
- `tabs.tab_heading.active_background_color` (color) — Active Background Color
- `tab_heading.heading` (text) — Heading
- `tab_heading.heading_size` (choice) — Size [required] — _HTML heading size_
- `tab_heading.heading_display_size` (choice) — Display Size [required] — _Size that heading is displayed at_
- `tab_heading.heading_color` (choice) — Color [required]
- `tab_heading.heading_color_custom` (color) — Color [when tab_heading.heading_color EQUAL custom]
- `tab_heading.heading_align` (choice) — Align [required]
- `tabs.tab_heading.class` (text) — CSS Class
...
- `tabs.heading.class` (text) — CSS Class
