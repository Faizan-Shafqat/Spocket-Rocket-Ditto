...
**Slug:** `sr-tabs-slider-01`
**HubSpot module ID:** 210345441581
...
**Module path:** `sr-2026/custom-modules/SR Tabs Slider 01.module`
...
- `slides.slide_image` (image) — Slide Image — _Recommended size: 2220x1480px_
