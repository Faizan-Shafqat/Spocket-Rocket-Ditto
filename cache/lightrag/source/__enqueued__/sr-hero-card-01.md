...
**Slug:** `sr-hero-card-01`
**HubSpot module ID:** 210345399192
**Inferred category:** Hero (card variant)
...
**Module path:** `sr-2026/custom-modules/SR Hero Card 01.module`
...
- **card_alignment** (group) — Card Alignment
...
- `card_alignment.vertical_alignment` (choice) — Vertical Alignment [required]
- `card_alignment.horizontal_alignment` (choice) — Horizontal Alignment [required]
