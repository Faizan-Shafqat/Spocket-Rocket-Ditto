...
**Slug:** `sr-cards-grid-01`
**HubSpot module ID:** 210344001539
...
**Module path:** `sr-2026/custom-modules/SR Cards Grid 01.module`
...
- **design_settings** (group) — Design Settings
  - **design_settings.card_styles** (group) — Card Styles
    - **design_settings.card_styles.hover_styles** (group) — Hover Style
...
- **1** (group — repeater(default=5, max=∞)) — Column
...
- `design_settings.enable_gap` (boolean) — Enable Card Gap — _Add a gap between the cards_
...
- `design_settings.hover_styles.background_color` (choice) — Background Color [required]
- `design_settings.hover_styles.background_gradient` (gradient) — Gradient [when design_settings.hover_styles.background_color EQUAL gradient]
- `design_settings.hover_styles.background_custom` (color) — Background Color [when design_settings.hover_styles.background_color EQUAL custom]
- `design_settings.hover_styles.text_color` (choice) — Text Color [required]
- `design_settings.hover_styles.text_color_custom` (color) — Text Color [when design_settings.hover_styles.text_color EQUAL custom]
- `design_settings.hover_styles.shadow` (boolean) — Shadow
- `design_settings.hover_styles.horizontal` (number) — Horizontal [when design_settings.hover_styles.shadow EQUAL true] — _A positive value puts the shadow on the right side of the box, a negative value puts the shadow on the left side of the box_
- `design_settings.hover_styles.vertical` (number) — Vertical [when design_settings.hover_styles.shadow EQUAL true] — _The vertical offset of the shadow. A positive value puts the shadow below the box, a negative value puts the shadow above the box_
- `design_settings.hover_styles.blur` (number) — Blur [when design_settings.hover_styles.shadow EQUAL true] — _The blur radius. The higher the number, the more blurred the shadow will be_
- `design_settings.hover_styles.spread` (number) — Spread [when design_settings.hover_styles.shadow EQUAL true] — _The spread radius. A positive value increases the size of the shadow, a negative value decreases the size of the shadow_
- `design_settings.hover_styles.inset` (boolean) — Inset [when design_settings.hover_styles.shadow EQUAL true] — _Changes the shadow to an inner shadow_
- `design_settings.hover_styles.color` (color) — Color [when design_settings.hover_styles.shadow EQUAL true] — _The color of the shadow_
...
- `column_heading.heading_color_custom` (color) — Color [when heading.heading_color EQUAL custom]
- `column_heading.heading_align` (choice) — Align [required]
- `column.heading.class` (text) — CSS Class
- `column.col_text` (richtext) — Text
- `col_lead_text` (boolean) — Lead Text — _Turn on to make the Description text larger_
...
- `grid_border_color` (color) — Grid Border Color
