...
**Slug:** `sr-cards-testimonial-grid-01`
**HubSpot module ID:** 210344001544
...
**Module path:** `sr-2026/custom-modules/SR Cards Testimonial Grid 01.module`
...
- **1** (group — repeater(default=5, max=∞)) — Cards
...
- `cards.quote` (richtext) — Quote
- `cards.author_image` (image) — Author Image — _Recommended size: 100x100px_
- `cards.author_name` (text) — Author Name
- `cards.author_title` (text) — Author Title
