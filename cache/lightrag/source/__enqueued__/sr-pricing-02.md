...
**Slug:** `sr-pricing-02`
**HubSpot module ID:** 210345737991
...
**Module path:** `sr-2026/custom-modules/SR Pricing 02.module`
...
- **pricing_heading** (group) — Pricing Heading
- **1** (group — repeater(default=2, max=3)) — Column
  - **pricing_name** (group) — Pricing Name
  - **price** (group) — Price
  - **cta** (group) — CTA
  ...
  - **column.features** (group — repeater(default=4, max=6)) — Features
    - **features.icon** (group) — Icon
- **columns** (group) — Columns
  - **left_column** (group — repeater(default=1, max=4)) — Content
  - **right_column** (group — repeater(default=1, max=4)) — Pricing
...
- `pricing_heading.class` (text) — CSS Class
- `pricing_description` (richtext) — Pricing Description
- `pricing_description_lead_text` (boolean) — Lead Text — _Turn on to make the Description text larger_
- `pricing_name.heading` (text) — Heading
- `pricing_name.heading_size` (choice) — Size [required] — _HTML heading size_
- `pricing_name.heading_display_size` (choice) — Display Size [required] — _Size that heading is displayed at_
- `pricing_name.heading_color` (choice) — Color [required]
- `pricing_name.heading_color_custom` (color) — Color [when pricing_name.heading_color EQUAL custom]
- `pricing_name.heading_align` (choice) — Align [required]
- `column.pricing_name.class` (text) — CSS Class
- `price.heading` (text) — Heading
- `price.heading_size` (choice) — Size [required] — _HTML heading size_
- `price.heading_display_size` (choice) — Display Size [required] — _Size that heading is displayed at_
- `price.heading_color` (choice) — Color [required]
- `price.heading_color_custom` (color) — Color [when price.heading_color EQUAL custom]
- `price.heading_align` (choice) — Align [required]
- `column.price.class` (text) — CSS Class
...
- `highlight_plan` (boolean) — Highlight Plan
- `column.card_gradient_from` (color) — Card Gradient From [when highlight_plan EQUAL true]
- `column.card_gradient_to` (color) — Card Gradient To [when highlight_plan EQUAL true]
- `column.card_text_color` (color) — Text Color [when highlight_plan EQUAL true]
