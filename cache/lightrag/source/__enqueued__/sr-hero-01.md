...
**Slug:** `sr-hero-01`
**HubSpot module ID:** 210345392442
...
**Module path:** `sr-2026/custom-modules/SR Hero 01.module`
...
- **12315b24-dc5a-720e-99f5-0b9c1ef90e5f** (group — when parallax EQUAL true) — Parallax Scroll Image
...
- `a0f1f5ba-479d-8e6c-c9c1-8f7f42e7e191` (image) — Image [when parallax EQUAL true]
- `ba4c9557-10f1-8d2d-fb71-5773a366385b` (number) — Top
- `36c0aff7-9d3b-277e-36cd-0cae2e90d6a0` (number) — Left
- `75e79362-0aaa-843e-e0f6-933fde7dd242` (number) — Right
- `f4dbbd4b-e351-df17-df23-219a495bd2c7` (number) — Width
- `ed828e20-be78-ef3a-3ea3-0346c4937615` (number) — Blur
