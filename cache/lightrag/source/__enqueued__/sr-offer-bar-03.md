...
**Slug:** `sr-offer-bar-03`
**HubSpot module ID:** 210345737882
...
**Module path:** `sr-2026/custom-modules/SR Offer Bar 03.module`
...
- **columns** (group) — Columns
  - **left_column** (group — repeater(default=1, max=4) ; when bling_image EQUAL null) — Content
  - **right_column** (group — repeater(default=1, max=4)) — Buttons
