...
**Slug:** `sr-cards-steps-02`
**HubSpot module ID:** 210345399129
...
**Module path:** `sr-2026/custom-modules/SR Cards Steps 02.module`
...
- **design_settings** (group) — Design Settings
  - **design_settings.card_styles** (group) — Card Styles
    - **design_settings.card_styles.hover_styles** (group) — Hover Styles
...
- **column** (group — repeater(default=3, max=∞)) — Column
...
- **column_size** (group — repeater(default=1, max=4)) — Column Size
...
- `column.col_step_text` (text) — Step
...
- `col_text` (richtext) — Description
- `column.lead_text` (boolean) — Lead Text — _Turn on to make the Description text larger_
...
- `column.accent_color` (color) — Accent Color
- `column.accent_color_hover` (color) — Accent Color Hover
- `column_size.column_breakpoint` (choice) — Column Breakpoint [required]
- `column_size.column_width` (choice) — Column Width [required]
- `column_size.column_offset` (choice) — Column Offset [required]
- `column_size.column_order` (number) — Column Order
