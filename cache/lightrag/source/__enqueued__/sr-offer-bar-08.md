...
**Slug:** `sr-offer-bar-08`
**HubSpot module ID:** 210345737893
...
**Module path:** `sr-2026/custom-modules/SR Offer Bar 08.module`
...
- `card_styles.background_image` (backgroundimage) — Background image [when card_styles.background_color EQUAL image]
...
- `design_settings.card_styles.background_blur` (number) — Background Blur
...
- `toggle_full_screen` (boolean) — Toggle Full Screen
