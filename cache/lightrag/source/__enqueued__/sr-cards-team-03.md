...
**Slug:** `sr-cards-team-03`
**HubSpot module ID:** 210345399134
...
**Module path:** `sr-2026/custom-modules/SR Cards Team 03.module`
...
- **1** (group — repeater(default=6, max=∞)) — Card
  - **fcef1c6a-6308-1d04-d7e0-7b4b4a4571ef** (group) — Social Icons
...
- `design_settings.overlay_color` (color) — Cards Overlay Color
...
- `0463ebe7-e07a-8f3d-17da-0da9d4352460` (link) — Social Link
- `social_icons.icon_type` (choice) — Icon Type [required]
- `social_icons.image` (image) — Image [when social_icons.icon_type EQUAL image]
- `social_icons.icon` (icon) — Icon [when social_icons.icon_type EQUAL icon]
- `social_icons.icon_color` (color) — Icon Color [when social_icons.icon_type EQUAL icon]
- `social_icons.icon_background` (color) — Icon Background [when social_icons.icon_type EQUAL icon]
- `social_icons.html` (text) — HTML [when social_icons.icon_type EQUAL custom]
- `social_icons.icon_size` (number) — Icon Size [when social_icons.icon_type NOT_EQUAL none]
...
- `99a51f45-5bc2-f7b4-607d-d6457fab6e82` (choice) — Column Size [required]
