...
**Slug:** `sr-event-listing-01`
**HubSpot module ID:** 210348825684
...
**Module path:** `sr-2026/custom-modules/SR Event Listing 01.module`
...
- **1** (group — repeater(default=3, max=∞)) — Column
