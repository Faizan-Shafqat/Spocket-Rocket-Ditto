...
**Slug:** `sr-cards-slider-01`
**HubSpot module ID:** 210345441370
...
**Module path:** `sr-2026/custom-modules/SR Cards Slider 01.module`
...
- **design_settings** (group) — Design Settings
  ...
  - **design_settings.slide_styles** (group) — Slide Styles
...
- **slides** (group — repeater(default=6, max=∞)) — Slides
  - **slides.heading** (group) — Heading
...
- `slide_styles.background_color` (choice) — Background Color [required]
- `slide_styles.background_gradient` (gradient) — Gradient [when slide_styles.background_color EQUAL gradient]
- `slide_styles.background_custom` (color) — Background Color [when slide_styles.background_color EQUAL custom]
- `slide_styles.text_color` (choice) — Text Color [required]
- `slide_styles.text_color_custom` (color) — Text Color [when slide_styles.text_color EQUAL custom]
- `slide_styles.spacing` (spacing) — Spacing
- `slide_styles.border` (border) — Border
- `design_settings.slide_styles.border_radius` (number) — Border Radius
...
- `slider_styles.arrow_hover_color` (color) — Arrows Color [when arrows EQUAL true]
...
- `slides.heading.heading` (text) — Heading
- `slides.heading.heading_size` (choice) — Size [required] — _HTML heading size_
- `slides.heading.heading_display_size` (choice) — Display Size [required] — _Size that heading is displayed at_
- `slides.heading.heading_color` (choice) — Color [required]
- `slides.heading.heading_color_custom` (color) — Color [when slides.heading.heading_color EQUAL custom]
- `slides.heading.heading_align` (choice) — Align [required]
