...
**Slug:** `sr-cards-testimonial-slider-05`
**HubSpot module ID:** 210345399143
...
**Module path:** `sr-2026/custom-modules/SR Cards Testimonial Slider 05.module`
...
- **1** (group — repeater(default=3, max=∞)) — Testimonials
...
- `design_settings.card_text_color` (choice) — Card Text Color [required] — _Set to Auto to use the default text colorSet to Custom to set a custom text color_
- `design_settings.card_text_color_custom` (color) — Card Text Color [when design_settings.card_text_color EQUAL custom]
...
- `60ebe301-fe72-f317-e30d-2d5b5ac82c31` (richtext) — Review
- `8ac21d73-a352-b701-3c3e-06f47043af82` (text) — Team Name
- `4cb9bbbe-69d9-b08e-987f-89e47038100b` (text) — Role
