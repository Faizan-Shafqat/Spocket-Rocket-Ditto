...
**Slug:** `sr-tabs-01`
**HubSpot module ID:** 210345441568
...
**Module path:** `sr-2026/custom-modules/SR Tabs 01.module`
...
- **1** (group — repeater(default=4, max=∞)) — Tabs
- **c47f3480-1eb0-4604-b761-975447dc2d30** (group) — Tab Style
...
- `1bbdc8fb-f503-f761-6d84-d6e40dedc303` (color) — Background Color
- `3076607c-2221-28d0-1155-b463c84db44b` (color) — Text Color
- `83300502-aa6f-6879-31aa-6d6e0521a3ed` (color) — Border Color
- `68d6e6a0-f3a0-b855-3f84-72cfa2a42c59` (choice) — Active Tab Style [when tab_style EQUAL custom] [required]
- `tabs_align` (choice) — Tabs Horizontal Alignment [required]
